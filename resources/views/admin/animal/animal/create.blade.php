    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="{{ route('admin.animal.store') }}" method="post" id="form"
                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group mb-1">
                                    ...
                                    <input type="text" name="scntf_name" value="{{ old('scntf_name') }}"
                                        class="form-control form-control-sm border-blue">
                                </div>
                                @error('scntf_name')
                                    <span class="text-danger">
                                ...
                                <div class="row">
                                    <section class="col-6">
                                        <div class="form-group mb-1">
                                            ...
                                            <input type="file" class="form-control form-control-sm border-blue"
                                    ...
                                    <section class="col-6">
                                        ...
                                        <select name="currentImage" class="form-control form-control-sm border-blue"
                                            ...
                                            @foreach ($val as $key => $value)
                                                <option value="{{ $key }}"
                                                    @if (old('currentImage') == $key) selected @endif> {{ $val[$key] }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </section>
                            ...
                            <section class="col-12 my-2">
                                <div class="form-group mb-1">
                                    ...
                                    <textarea type="text" name="threatening_factors" id="threatening_factors"
                                        class="form-control form-control-sm border-blue" value="">{{ old('threatening_factors') }} </textarea>
                                </div>
                                    ...
                                    <select name="category_id" id=""
                                        ...
                                        @foreach ($animalCategories as $animalCategory)
                                            <option value="{{ $animalCategory->id }}"
                                                @if (old('category_id') == $animalCategory->id) selected @endif>
                            ...
                            <section class="col-12 my-2">
                                <div class="form-group mb-1">
                                    ...
                                    <select class="select2 form-control form-control-sm col-12 border-blue"
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group mb-1">
                                    ...
                                    <select name="status" id=""
                                        class="form-control form-control-sm border-blue" id="status">
                                    ...
                                    <section class="col-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-sm"
                                                placeholder="ویژگی ..." id="meta_key[]" name="meta_key[]"
                                                value="{{ old('meta_key.0') }}">
                                        </div>
                                    </section>
                                    <section class="col-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-sm"
                                                placeholder="مقدار ..." id="meta_value[]" name="meta_value[]"
                                                value="{{ old('meta_value.0') }}">
                                        </div>
                                    </section>
                                </section>
                                <section>
                                    <button type="button" class="btn light-blue btn-sm btn-hover"
                                        id="addAttributeButton">افزودن ویژگی</button>
                                </section>
                            </section>
