...
<section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section>
                <form action="{{ route('admin.animal.update' , $animal->id) }}" method="post" id="form" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <section class="row">
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group mb-1">
                                ...
                                <input type="text" name="name" value="{{ old('name' , $animal->name) }}" class="form-control form-control-sm border-blue">
                            </div>
                            @error('name')
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group mb-1">
                                ...
                                <input type="text" name="english_name" value="{{ old('english_name' , $animal->english_name) }}" class="form-control form-control-sm border-blue">
                            </div>
                            @error('english_name')
                            <span class="text-danger">
                                <strong>
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group mb-1">
                                ...
                                <input type="text" name="scntf_name" value="{{ old('scntf_name' , $animal->scntf_name) }}" class="form-control form-control-sm border-blue">
                            </div>
                            @error('scntf_name')
                            <span class="text-danger">
                                <strong>
                            ...
                            <div class="row">
                                ...
                                <section class="col-6">
                                    ...
                                    <select name="currentImage" class="form-control form-control-sm border-blue" id="currentImage">
                                        ...
                                        <option value="{{ $key }}" @if(old('currentImage' , $animal->image['currentImage'])==$key) selected @endif> {{ $val[$key] }}</option>
                                        @endforeach
                                    </select>
                                </section>
                            </div>
                        ...
                        <section class="col-12 my-2">
                            <div class="form-group mb-1">
                                ...
                                <textarea type="text" name="threatening_factors" id="threatening_factors" class="form-control form-control-sm border-blue" value="">{{ old('threatening_factors' , $animal->threatening_factors) }} </textarea>
                            </div>
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group mb-1">
                                ...
                                <select name="category_id" id="" class="form-control form-control-sm border-blue">
                                    ...
                                    <option value="{{ $animalCategory->id }}" @if(old('category_id' , $animal->category_id) == $animalCategory->id) selected @endif>{{ $animalCategory->name }}</option>
                                    @endforeach
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group mb-1">
                                ...
                                <select name="protective_id" id="" class="form-control form-control-sm border-blue">
                                    ...
                                    <option value="{{ $protective->id }}" @if(old('protective_id' , $animal->protective_id)==$protective->id) selected @endif>{{ $protective->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('protective_id')
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group mb-1">
                                ...
                                <input type="text" name="height" value="{{ old('height' , $animal->height) }}" class="form-control form-control-sm border-blue">
                            </div>
                            @error('height')
                            <span class="text-danger">
                                <strong>
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group mb-1">
                                ...
                                <input type="text" name="weight" value="{{ old('weight'  , $animal->weight) }}" class="form-control form-control-sm border-blue">
                            </div>
                            @error('weight')
                            <span class="text-danger">
                                <strong>
                        ...
                        <section class="col-12 my-2">
                            <div class="form-group mb-1">
                                ...
                                <input type="hidden" class="form-control form-control-sm border-blue" name="tags" id="tags" value="{{ old('tags' , $animal->tags) }}">
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group mb-1">
                                ...
                                <input type="text" id="published_at_view" class="form-control form-control-sm  border-blue" value="{{ old('published_at' , $animal->published_at) }}">
                            </div>
                            @error('published_at')
                            <span class="text-danger">
                                <strong>
                        ...
                        <section class="col-12">
                            <button class="btn blue-color btn-md text-white mr-3">ثبت</button>
                        </section>
                    </section>
                </form>
            </section>
            ...
            <section class="col-12 py-1 mb-1" id="metaDiv">
                ...
                <section class="row">
                    ...
                    <form action="{{ route('admin.animal.meta.destroy',  $meta->id) }}" method="post" class="d-inline" id="deleteForm">
                        @csrf
                        @method('delete')
                        <button type="submit" class="btn btn-lg btn-hover p-0 delete text-danger" title="حذف ویژگی"><i class="fa fa-minus-square"></i></button>
                    </form>
                    <span class="btn btn-lg btn-hover p-0 text-primary mx-2" onclick="setMetaVal('{{ $meta->meta_key }}' , '{{ $meta->meta_value }}' , '{{ $meta->id }}')" data-url="{{route('admin.animal.meta.update' ,  $meta->id)}}" id="editMetaButton" title="ویرایش ویژگی" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo"><i class="far fa-edit"></i></span>
                </section>
                @endforeach
            </section>
            <form action="{{ route('admin.animal.meta.store', $animal->id) }}" method="post" id="addMetaForm">
                ...
                <section class="col-12 mb-1 d-none" id="addmetaSection">
                    <section class="row">
                        <section class="col-5">
                            <div class="form-group">
                                <input type="text" class="form-control form-control-sm" placeholder="ویژگی ..." id="meta_key[]" name="meta_key[]" value="{{ old('meta_key') }}">
                            </div>
                            @error('meta_key.*')
                            <span class="text-danger">
                                <strong>
                        ...
                        <section class="col-5">
                            <div class="form-group">
                                <input type="text" class="form-control form-control-sm" placeholder="مقدار ..." id="meta_value[]" name="meta_value[]" value="{{ old('meta_value') }}">
                            </div>
                            @error('meta_value.*')
                            <span class="text-danger">
                                <strong>
                ...
                <section class="">
                    <button type="button" class="btn light-blue btn-sm" id="addmetaButton">افزودن ویژگی</button>
                </section>
            </form>
            <br>
            ...
            <section class="col-12 mt-3 d-none" id="submitmetaEditFormButton">
                <button class="btn blue-color btn-md text-white" onclick="submitmetaEditForm()" title="ثبت ویژکی های جدید">ثبت</button>
            </section>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                                ...
                                <section class="row">
                                    <section class="col-6">
                                        <div class="form-group mb-1">
                                            ...
                                            <input type="text" name="meta_key[]" id="meta_key" class="form-control form-control-sm border-blue" value="">
                                        </div>
                                    </section>
                                    <section class="col-6">
                                        <div class="form-group">
                                            <label for="meta_value[]" class="blue">مقدار</label>
                                            <input type="text" name="meta_value[]" id="meta_value" class="form-control form-control-sm border-blue" value="">
                                        </div>
                                    </section>
                                </section>
                            </section>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn blue-color text-white" id="" onclick="submitForm($('#meta_key').val(),$('#meta_value').val(),$('#metaId').val())">ثبت</button>
                        </div>
                    </div>
                </div>
            </div>
...
@include('admin.alerts.sweetalerts.confirm', ['className' => 'delete' , 'message' => 'ویژگی حذف شود؟'])
