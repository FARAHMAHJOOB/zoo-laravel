...
@section('content')
    <nav aria-label="breadcrumb ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-15 active" aria-current="page"><a href="{{ route('admin.role.index') }}"> سطوح
                    دسترسی </a></li>
            <li class="breadcrumb-item font-size-15"> نقش جدید</li>
        </ol>
    </nav>
    <section class="row">
                ...
                <section>
                    <form action="{{ route('admin.role.store') }}" method="post">
                        ...
                        <section class="row">
                            ...
                            <section class="main-body-container-header mr-3 mt-5">
                                <h5>
                                    دسترسی ها
                                </h5>
                            </section>
