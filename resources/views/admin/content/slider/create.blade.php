...
<nav aria-label="breadcrumb ">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item font-size-15 active" aria-current="page"> اسلاید جدید </li>
    </ol>
</nav>
<section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <div>
                <form action="{{ route('admin.content.slider.store') }}" method="post" id="form" enctype="multipart/form-data">
                    @csrf
                    <section class="row">
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group mb-1">
                                <label class="blue" for="alt">متن عکس</label>
                                <input type="text" class="form-control form-control-sm" id="alt" name="alt" value="{{ old('alt') }}">
                            </div>
                            @error('alt')
