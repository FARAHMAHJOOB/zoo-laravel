...
<nav aria-label="breadcrumb ">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item font-size-15 active" aria-current="page">ویرایش سوال</li>
    </ol>
</nav>
                        ...
                        <section class="row">
                            <section class="col-12 my-2">
                                <div class="form-group mb-1">
                                    <label class="blue"  for="question">پرسش</label>
                            ...
                            <section class="col-12 my-2">
                                <div class="form-group mb-1">
                                    <label class="blue"  for="answer">پاسخ</label>
                                    <textarea name="answer" id="answer" class="form-control form-control-sm" rows="4">{{ old('answer' , $faq->answer) }}"</textarea>
                                </div>
                                @error('answer')
                                <span class="text-danger">
                                    <strong>
